 ...
 */
package src.gestaovenda.modelo.controller;

import src.gestaovenda.modelo.dao.AutenticacaoDao;
import src.gestaovenda.modelo.util.AbstractMouseListener;
import src.gestaovenda.modelo.dao.CategoriaDao;
import src.gestaovenda.modelo.dao.ClienteDao;
import src.gestaovenda.modelo.dao.ProdutoDao;
import src.gestaovenda.modelo.dao.UsuarioDao;
import src.gestaovenda.modelo.dao.VendaDao;
import src.gestaovenda.modelo.entidades.Cliente;
import src.gestaovenda.modelo.entidades.Produto;
import src.gestaovenda.modelo.entidades.Usuario;
import src.gestaovenda.modelo.entidades.Venda;
import src.gestaovenda.modelo.entidades.VendaDetalhes;
import src.gestaovenda.modelo.exception.NegocioException;
import src.gestaovenda.modelo.util.VendaRegistroTableModel;
import src.gestaovenda.modelo.util.VendaTableModel;
import src.gestaovenda.view.formulario.Dashboard;
