...
import src.gestaovenda.view.formulario.LoginForm;
import src.gestaovenda.view.modelo.LoginDto;
...
public class AutenticacaoController implements ActionListener{
    ...
    private void login() {
        ...
        /// Get senha que é preenchida no form Login
